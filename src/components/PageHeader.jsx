  ...
  return (
    <section className="relative overflow-hidden border-b border-slate-200/60 dark:border-white/10">
      ...
      <Container className="relative py-14 sm:py-16">
        ...
        <motion.h1
          className="mt-4 font-heading text-4xl font-extrabold tracking-tight text-slate-950 dark:text-white sm:text-5xl"
        ...
        {subtitle ? (
          <motion.p
            className="mt-4 max-w-3xl text-base font-semibold leading-relaxed text-slate-600 dark:text-slate-300 sm:text-lg"
            initial={{ opacity: 0, y: 12 }}
            animate={{ opacity: 1, y: 0 }}
